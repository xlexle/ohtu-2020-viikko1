...
public class Varasto {
    ...
    public Varasto(double tilavuus, double alkuSaldo) { // kuormitetaan
        this.tilavuus = maaritaTilavuus(tilavuus);
    ...
    private double maaritaTilavuus(double tilavuus) {
        return tilavuus > 0.0 ? tilavuus : 0.0;
    }

    private double maaritaAlkuSaldo(double tilavuus, double alkuSaldo) {
        if (alkuSaldo > 0.0) {
